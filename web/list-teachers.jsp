...
<html>
    <head>
        ...
        <title>List teachers - LibraryAdmin</title>  <meta content="" name="description">
              ...
              <tbody>
                <c:forEach items="${enseignants}" var="enseignant">
                  <tr>
                      ...
                      <td>${enseignant.getPersonne().getPrenom()}</td>
                      <td>${enseignant.getPersonne().getNom()}</td>
                      <td>${enseignant.getPersonne().getLogin()}</td>
                      <td>${enseignant.getPersonne().getEmail()}</td>
                      <td>${enseignant.getPersonne().getAdresse()}</td>
                      <td>${enseignant.getPersonne().getTelephone()}</td>
                      ...
                      <td>
                        ...
                        <a href="deleteUser?idpers=${enseignant.idens }" onclick="return confirm();" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Delete"><i class="bi bi-trash3"></i></a>
                      </td>
                  </tr>
                </c:forEach>
              </tbody>
