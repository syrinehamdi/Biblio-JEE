      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">${sessionScope.admin.prenom} ${sessionScope.admin.nom}</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
            <c:if test="${!empty sessionScope.admin.nom && !empty sessionScope.admin.prenom}"> 
              <h6>${sessionScope.admin.prenom} ${sessionScope.admin.nom}</h6>
            </c:if>
            </li>
            <li>
              <hr class="dropdown-divider">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="user-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <!--<li>
            <a class="btn btn-link" onclick="showModal()">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="reservationServlet">
          <i class="bi bi-question-circle"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="borrowingServlet">
