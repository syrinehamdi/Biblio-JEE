...
<html>
    <head>
        ...
        <title>List students - LibraryAdmin</title>  <meta content="" name="description">
              ...
              <tbody>
                <c:forEach items="${etudiants}" var="etudiant">
                  <tr>
                      ...
                      <td>${etudiant.getPersonne().getPrenom()}</td>
                      <td>${etudiant.getPersonne().getNom()}</td>
                      <td>${etudiant.getPersonne().getLogin()}</td>
                      <td>${etudiant.getPersonne().getEmail()}</td>
                      <td>${etudiant.getPersonne().getAdresse()}</td>
                      <td>${etudiant.getPersonne().getTelephone()}</td>
                      ...
                      <td>
                        ...
                        <a href="deleteUser?idpers=${etudiant.idetud }" onclick="return confirm();" class="btn btn-outline-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Delete"><i class="bi bi-trash3"></i></a>
                      </td>
                  </tr>
                </c:forEach>
              </tbody>
